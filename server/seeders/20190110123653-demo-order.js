...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    return queryInterface.bulkInsert(
      'orders',
      _d.map(data, row => _d.pick(row, 'id', 'customerid','deliverystoreid','deliveryaddress','deliverycontact','deliverytime','pickupstoreid','pickuptime','isstorepickup','totalamount','orderstatusid')),
      {}
    )
  },
